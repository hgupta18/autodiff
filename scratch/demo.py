...
def newton_demo_trig():
    '''
      This function demos a 1D Newton root finding algorithm. In this example we are
      finding the root of f(x) = sin(x) + cos(x) with the initial guess x_0 = 2
    '''
    function = lambda x: x.sin() + x.cos() # Function we want root of
    my_number = ad.AutoDiff(2)             # Initial value
    root = my_number.val                   # Real component of initial value
...
if __name__ == '__main__':
    print(newton_demo_power())
    print(newton_demo_trig())
